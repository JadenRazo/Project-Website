...
cd "${BACKEND_DIR}"
echo -e "${YELLOW}Database schema location: ${BACKEND_DIR}/schema.sql${NC}"
echo -e "${YELLOW}To initialize database, run: psql -d project_website -f ${BACKEND_DIR}/schema.sql${NC}"
