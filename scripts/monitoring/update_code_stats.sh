...
OUTPUT_JSON_FILE_RELATIVE="Project-Website/frontend/public/code_stats.json"
...
# Assuming the script is always at <workspace_root>/main/Project-Website/scripts/monitoring/update_code_stats.sh
